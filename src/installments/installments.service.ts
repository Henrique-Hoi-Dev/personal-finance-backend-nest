...
export class InstallmentsService {
   ...
   * Ported from legacy: createInstallmentsFromAmount
   */
  async createInstallmentsFromAmount(
    ...
    try {
      ...
      const totalAmount = input.installmentAmount * input.installments;

      // Reuse createInstallmentsFromTotalAmount logic
      return this.createInstallmentsFromTotalAmount(
        input.accountId,
        totalAmount,
        input.installments,
